...
export default function Index() {
  return (
    <section
      className="lg:px-6 w-full px-3 antialiased bg-indigo-600"
      data-tails-scripts="//unpkg.com/alpinejs"
    >
      <div className="max-w-7xl mx-auto">
        <div className="sm:px-4 container py-32 mx-auto text-center">
          <h1 className="sm:text-5xl sm:leading-none md:text-6xl xl:text-7xl text-4xl font-extrabold leading-10 tracking-tight text-white">
            <span className="block">Airbnb Property Management</span>{" "}
            <span className="relative inline-block mt-3 text-white">
              design websites
            </span>
          </h1>
          <div className="md:mt-12 sm:text-base md:max-w-xl md:text-lg xl:text-xl max-w-lg mx-auto mt-6 text-sm text-center text-indigo-200">
...
<!-- Section 1 -->
<section class="w-full px-3 antialiased bg-indigo-600 lg:px-6" data-tails-scripts="//unpkg.com/alpinejs">
    <div class="mx-auto max-w-7xl">
        ...
        <div class="container py-32 mx-auto text-center sm:px-4">
            ...
            <h1 class="text-4xl font-extrabold leading-10 tracking-tight text-white sm:text-5xl sm:leading-none md:text-6xl xl:text-7xl"><span class="block">Airbnb Property Management</span> <span class="relative inline-block mt-3 text-white">design websites</span></h1>
            <div class="max-w-lg mx-auto mt-6 text-sm text-center text-indigo-200 md:mt-12 sm:text-base md:max-w-xl md:text-lg xl:text-xl">Professional vacation rental hosting and management. We provide               guest-driven hospitality services in North Texas including event               planning &amp; concierge services.</div>
